...
const YtContent = () => {
  ...
  return (
    <>
      <div className="content overflow-y-scroll md:max-h-[102vh] pt-8 md:pt-[3rem] scroll_hide ">
          {modal && (
            <ModelContent
          ...
          <div className="p-2 ">
            ...
            <h2 className=" text-3xl font-bold mb-2 pt-1  pb-2 ">Your contents</h2>
            {/* <p class="text-xs mb-4 pt-1 border-b border-[#393939e4] pb-2 text-[#5e5e5e]">
              Here you can manage your channel content, including videos,
              shorts, playlists, and community posts. Click on the edit icon to
