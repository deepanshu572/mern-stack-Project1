...
const DashBoard = () => {
  ...
  return (
    <div className="p-3 overflow-y-scroll md:h-[102vh] py-[3rem] scroll_hide">
      <div className="head">
      ...
      <div className="box_flex flex gap-2 mt-4 flex-wrap ">
        ...
        <div className="box cursor-pointer border border-[#393939e4] bg-gradient-to-br from-black/90 via-white/10 to-black/90 shrink-0 flex items-center justify-between px-3 w-[43vw] md:w-[14rem] h-[8rem] rounded-md overflow-hidden relative">
          <div className="flex flex-col justify-center h-full ">
            <h1 className="text-3xl font-bold">{channel?.shorts?.length}</h1>
        ...
        <div className="box cursor-pointer border border-[#393939e4] bg-gradient-to-br from-black/90 via-white/10 to-black/90 shrink-0 flex items-center justify-between px-3 w-[43vw] md:w-[14rem] h-[8rem] rounded-md overflow-hidden relative">
          <div className="flex flex-col justify-center h-full">
            <h1 className="text-3xl font-bold">{channel?.videos?.length}</h1>
      ...
      <div className="channel_wrap flex md:flex-row flex-col gap-7 mt-8 items-start ">
        <div className="channel_Data  ">
          <h3>Latest Videos</h3>
          {channel?.videos?.map((item) => {
            return (
              <div className="channels_videos mt-4 ">
                <div className="card_data flex mb-2 items-center gap-2 bg-[#0b0b0b61] p-2 md:w-[25rem]">
                  ...
                  <div className="card_des flex flex-col gap-1">
                    <h3 className="text-[10px] line-clamp-2">{item?.title}</h3>
                    ...
                    <div className="flex gap-4 ">
                      ...
                      <div className="box flex gap-1 items-center">
                        ...
                        <p className="text-[10px]">{item?.comments?.length}</p>
                      </div>
                    </div>
                  </div>
                </div>
